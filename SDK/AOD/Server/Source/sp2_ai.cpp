...
{
    //Changed for AOD
	const REAL32 ImportanceStrength	= 0.7f;
	const REAL32 ImportanceMoney		= 0.2f;
	const REAL32 ImportanceStability	= 0.1f;
...
/*
	...
	//Disable for AOD, if they AI has lost its army, it will not recover the lost regions, peace it
	const vector <GRegionControl>& l_vControls = g_ServerDAL.RegionControlArray();
...
{
    //Changed for AOD
	const REAL32 c_iNbBoatsByStrength = 0.02f;
	const REAL32 c_iNbPlanesByStrength = 0.7f;
	const REAL32 c_iNbGroundsByStrength = 4.5f;
